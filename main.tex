...
def cross(self, other):
    ...
    opi = offsets[parents[indexes]]
    ocpi = other.counts[parents[indexes]]

    left = self.offsets[parents[indexes]][:-1] + (
               (indexes - opi) // ocpi)
    right = other.offsets[parents[indexes]][:-1] + (
               indexes - opi) - ocpi * ((indexes - opi) // ocpi)
